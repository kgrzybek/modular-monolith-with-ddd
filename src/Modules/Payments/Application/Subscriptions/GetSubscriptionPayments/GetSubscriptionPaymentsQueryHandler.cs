...
{
    internal class GetSubscriptionPaymentsQueryHandler : IQueryHandler<GetSubscriptionPaymentsQuery, List<SubscriptionPaymentDto>>
    {
        ...
        public async Task<List<SubscriptionPaymentDto>> Handle(GetSubscriptionPaymentsQuery query, CancellationToken cancellationToken)
        {
            var connection = _sqlConnectionFactory.GetOpenConnection();

            var subscriptionPayments = await connection.QueryAsync<SubscriptionPaymentDto>("SELECT " +
