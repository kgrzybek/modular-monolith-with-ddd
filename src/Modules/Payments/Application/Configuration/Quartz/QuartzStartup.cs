...
using CompanyName.MyMeetings.Modules.Payments.Application.Configuration.Processing.Inbox;
...
namespace CompanyName.MyMeetings.Modules.Payments.Application.Configuration.Quartz
{
