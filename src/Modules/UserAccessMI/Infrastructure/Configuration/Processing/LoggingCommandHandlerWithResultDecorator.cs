    ...
    where T : ICommand<TResult>
{
    ...
    public async Task<TResult> Handle(T command, CancellationToken cancellationToken)
    {
        using (
            LogContext.Push(
                new LoggingCommandHandlerWithResultDecorator<T, TResult>.RequestLogEnricher(_executionContextAccessor),
                new LoggingCommandHandlerWithResultDecorator<T, TResult>.CommandLogEnricher(command)))
        {
            try
            {
