...
namespace CompanyName.MyMeetings.API.Modules.Meetings.Meetings
{
    ...
    public class MeetingsController : ControllerBase
    {
        ...
        {
            await _meetingsModule.ExecuteCommandAsync(new CreateMeetingCommand(request.MeetingGroupId, request.Title,
        ...
        public async Task<IActionResult> EditMeeting([FromRoute] Guid meetingId,
            [FromBody] ChangeMeetingMainAttributesRequest mainAttributesRequest)
        {
            await _meetingsModule.ExecuteCommandAsync(new ChangeMeetingMainAttributesCommand(meetingId,
                ...
                mainAttributesRequest.TermEndDate, mainAttributesRequest.Description,
                mainAttributesRequest.MeetingLocationName, mainAttributesRequest.MeetingLocationAddress,
                mainAttributesRequest.MeetingLocationPostalCode, mainAttributesRequest.MeetingLocationCity,
        ...
        public async Task<IActionResult> AddMeetingAttendee([FromRoute] Guid meetingId,
            [FromBody] AddMeetingAttendeeRequest attendeeRequest)
        {
            await _meetingsModule.ExecuteCommandAsync(new AddMeetingAttendeeCommand(meetingId,
        ...
        public async Task<IActionResult> RemoveMeetingAttendee(Guid meetingId, Guid attendeeId,
